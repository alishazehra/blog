...
{/* </div> */}
    ...
    <div className='flex gap-2'>
   <img src=" https://th.bing.com/th/id/R.da99f9d665e84a6c675810314540c992?rik=kzusRhmQLYe47w&pid=ImgRaw&r=0" alt="menu"  height={"30%"} width={"30%"} />
...
<hr />
<div className='flex gap-2'><img src="https://cdn.tasteatlas.com/Images/Dishes/e668e32ae1a3423c95fbd4d77f8c940c.jpg" alt="samosa" height={"30%"} width={"30%"} /> <strong className='text-white'>The samosa is prepared with an all-purpose flour (locally known as maida) and stuffed with a filling, often a mixture of diced and cooked or mashed boiled potato (preferably diced), onions, Lorem ipsum dolor sit amet consectetur adipisicing elit. Officia enim repellat adipisci modi voluptatem placeat, quasi non! Praesentium repellendus voluptate aspernatur optio. Odio laborum facere voluptate quod? Facere, vel delicious.</strong> </div>
<br />
